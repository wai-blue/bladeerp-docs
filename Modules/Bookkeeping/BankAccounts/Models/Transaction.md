# Model Bookkeeping/BankAccounts/Transaction
...
| urlBase               | bookkeeping/bank-accounts/transactions         |
| lookupSqlValue        |                                                |
| tableTitle            | Bank Transaction                               |
| formTitleForInserting | New Transaction                                |
| formTitleForEditing   | Bank Transaction                               |
| crud/browse/action    | Bookkeeping/BankAccounts/Transactions          |
| crud/add/action       | Bookkeeping/BankAccounts/Transaction/AddOrEdit |
| crud/edit/action      | Bookkeeping/BankAccounts/Transaction/AddOrEdit |
...
| :----------------------- | :-------------------------------------------------------------------------------------------------------------------- | :------: | -------- | -------- |
| id_bkp_currency          | [App/Widgets/Bookkeeping/ExchangeRate/Models/Currency](BankAccount.md)bkp_currencies |   1:N    | Cascade  | Restrict |
| id_bkp_bank_account      | [App/Widgets/Bookkeeping/BankAccounts/Models/BankAccount](BankAccount.md)                    |   1:N    | Cascade  | Restrict |
