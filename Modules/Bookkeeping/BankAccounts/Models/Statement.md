# Model Bookkeeping/BankAccounts/Statement
...
| urlBase               | bookkeeping/bank-accounts/statements         |
| lookupSqlValue        |                                              |
...
| formSaveButtonText    |                                              |
| crud/browse/action    | Bookkeeping/BankAccounts/Statements          |
| crud/add/action       | Bookkeeping/BankAccounts/Statement/AddOrEdit |
| crud/edit/action      | Bookkeeping/BankAccounts/Statement/AddOrEdit |
...
| :------------------ | :------------------------------------------------------------------------------------------------- | :------: | -------- | -------- |
| id_bkp_bank_account | [App/Widgets/Bookkeeping/BankAccounts/Models/BankAccount](BankAccount.md) |   1:N    | Cascade  | Cascade  |
