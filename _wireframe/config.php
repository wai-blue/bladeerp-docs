...
$config['sidebarItems'] = [
  ...
  "itemSellings" => ["text" => "Skladové hospodárstvo", 'icon' => 'fas fa-warehouse', 'cssStyle' => 'margin-left:10px;' ],
  "stockrooms" => ["text" => "Sklady", 'icon' => 'fas fa-warehouse', 'cssStyle' => 'margin-left:10px;' ],
  "items" => ["text" => "Tovary", 'icon' => 'fas fa-pallet', 'cssStyle' => 'margin-left:10px;' ],
...
$config['globalUnits'] = [
  ...
  "countries" => ['Albania', 'Andorra', 'Armenia', 'Austria', 'Azerbaijan', 'Belarus', 
    'Belgium', 'Bosnia and Herzegovina', 'Bulgaria', 'Croatia', 'Cyprus', 'Czech Republic', 'Slovakia']
];